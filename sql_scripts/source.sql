...
FROM 'E:\Everything\Works\HCMUSProject\BI\us-flights-etl\data\airlines.csv'
WITH
(
	FORMAT = 'CSV',
    FIRSTROW = 2,
...
FROM 'E:\Everything\Works\HCMUSProject\BI\us-flights-etl\data\filtered_airpoirt.csv'
WITH
(
	FORMAT = 'CSV',
    FIRSTROW = 2,
...
FROM 'E:\Everything\Works\HCMUSProject\BI\us-flights-etl\data\filtered_flights_1.csv'
WITH
(
	FORMAT = 'CSV',
...
FROM 'E:\Everything\Works\HCMUSProject\BI\us-flights-etl\data\filtered_flights_2.csv'
WITH
(
	FORMAT = 'CSV',
	CODEPAGE = '65001', -- UTF-8
...
FROM 'E:\Everything\Works\HCMUSProject\BI\us-flights-etl\data\filtered_flights_3.csv'
WITH
(
	FORMAT = 'CSV',
	CODEPAGE = '65001', -- UTF-8
